...
api_key_live = 'YOUR_API_KEY'
api_secret_live = 'YOUR_API_KEY'
...
def wait_for_price():
    ...
    while initial_price['XRPUSDT']['time'] > datetime.now() - timedelta(minutes=TIME_DIFFERENCE):
        ...
        for coin in initial_price:
            ...
            #print (f'{coin} PRICE IS  {initial_price[coin]['price']}')
