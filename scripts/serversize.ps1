...
Send-MailMessage -to "<insert address here>" -from "<insert address here>" -Subject "DB Status" -SmtpServer mail.smtp.com -Attachments "C:\PowerShell\Reports\Databases.Xml"
